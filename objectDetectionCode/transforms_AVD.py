'''
This script isn't really used because I "translated" the AVD annotations into
COCO format in order to use the "stock" COCO code. Inside this transforms script
there are some potentially useful functions to (also) perform data augmentation,
if AVD format was kept from the beginning. For instance: AddBackgroundBoxes,
ResizeImage, AddRandomBoxes, BlackOutObjects.
'''
